    ...
    "sections": [
      {
        ...
        "p": [
          ...
          "中心的な発見は、<em>クリエイティブとして優れ、かつ効果的な広告は、そうでない広告の4倍以上の利益を生む</em>というものだ。さらに同社は、短期の売上指標よりも、長期のブランド価値への寄与のほうがマーケティングのROIと強く相関していた、という意外な結果も報告している。"
        ]
      },
      {
        "num": "02",
        "h": "余裕がないほど、クリエイティブの質が効く",
        "p": [
          "この結果を、予算に余裕のある大企業の話だと読むと、いちばん大事な示唆を取りこぼす。むしろ逆で、<em>余裕がない企業こそ、クリエイティブの質から降りてはいけない</em>。理由はシンプルだ。使える予算が小さいほど、一回の広告のムダが致命傷になる。質の高いクリエイティブが同じ出稿費で4倍の利益を生むなら、それは資金力のない企業にとってこそ、限られた一発を最大化する数少ない手段になる。",
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、まず今日できることは一つだ。次に出す広告や発信を「数」や「今週の反応」だけで判断するのをやめて、<em>質の基準を一つ決める</em>こと。たとえば「毎回、同じ色・同じ言い回し・同じ人物を必ず入れる」と決めるだけでいい。派手さより一貫性が、限られた予算では効く。",
      ...
      },
      {
        ...
        "p": [
          "私たちがこの調査から受け取りたいのは、優れたクリエイティブへの投資が、けっして余裕のある企業だけの贅沢ではないという安心感だ。良い一本は、今日の売上を作りながら、同時に明日の想起を仕込む——<em>二度働いてくれる</em>。",
          "だからこそ、資金が限られているときほど、クリエイティブの質を最後に削るコストとして扱わないことをおすすめしたい。質を守ることは、利益を守ることと矛盾しない。"
        ]
      }
    ],
    "pullquote": "余裕がないほど、質は削れない。優れた一本が、限られた一発を最大化する。",
    "takeaways": [
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、まず持ちたいのは、獲得効率の指標と並ぶ「想起の指標」を一つ決めることだ。指名検索数でも、直接流入の推移でも、簡単な想起率の調査でもいい。完璧な計測を待つより、<em>記憶に残れているか</em>を定点で見る習慣を先に置こう。数字が一本増えるだけで、いま買わない人への発信が「見える活動」に変わる。",
    ...
    "sections": [
      ...
      },
      {
        ...
        "p": [
          ...
          "その一つが決まったら、告知する相手を新規だけに絞らないこと。過去の顧客リストは「休眠」ではなく<em>再起動待ちの資産</em>として扱いたい。そして刷新を語るときは「変えたこと」ではなく「あなたにとって何が良くなったか」で伝える。記憶の上に差分を重ねる一手は、新しい旗を立てるより静かだが、届く距離はずっと長い。"
        ]
      }
    ],
