    ...
    "sections": [
      ...
      },
      {
        ...
        "p": [
          ...
          "点検の観点は三つで足りる。語った品質は体験と一致しているか。語った価格の納得感は購入後も保てているか。語った世界観は、問い合わせ対応や梱包の細部まで届いているか。ずれが見つかったら、<em>まず実体を約束に追いつかせ、それから語りを強くする</em>。この順番で作られたブランドこそ、計測が進化するほど有利になる。検証される時代は、まっとうに作ってきた側の味方だ。"
        ]
      }
    ],
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、まず問い直したいのは、自社の商品が顧客の人生において「何を意味するか」だ。機能や品質の優位だけで勝負していないか。同じ機能を持つ競合が現れた瞬間、その優位は消える。だが<em>意味の設計は、機能の改良よりずっと寿命が長い</em>。まずは自社の商品を「〇〇のための道具」と一言で言い切ってみることから始めよう。",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、まず今日試したいのは、自社の技術や商品の説明を一度声に出して読み、機能の列挙から入っていないかを疑ってみることだ。「何ができるか」で始まっていたら、そこを<em>誰の何が変わるか</em>から語り直してみる。スペックは、それが誰のどんな困りごとを解くのかとセットになって、初めて意味を持つ。",
