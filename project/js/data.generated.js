  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、もし業界共通の取り組みや標準化の波に乗ろうとしているなら、まず二段構えで考えたい。業界の信用を借りて商談の入口を広げること。そして、その内側で「自社だけの差別軸」をどこに立てるか。この二つは二者択一ではなく、<em>同時に設計するもの</em>だ。まずは後者を一つ、名指ししてみよう。",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、もしリブランドや再挑戦を検討しているなら、まず決めるべきは刷新案ではない。<em>絶対に変えない一行</em>を先に決めることだ。誰に何を約束するのか——その判断基準を一行に落としてから、デザインやネーミングの議論に入る。順番を逆にすると、器だけが新しくなり、中身が空になる。",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、まず今日できることは、自社の日常業務のうち「他社が簡単には真似できないもの」を三つ書き出してみることだ。長年の管理のしかた、地域や取引先との関係、製造ラインの癖——社内では当たり前でも、外から見れば差別化の核になりうる。その三つが、あなたの会社の<em>翻訳前の原水</em>だ。",
