  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、もし発信のトーンが担当者によってばらつくと感じているなら、まずやるべきはルール集を厚くすることではない。<em>声を一点に集約する装置</em>を考えることだ。膨大なガイドラインより、一つの明確な人格のほうが、現場は迷わない。まずは自社の発信を数本読み返して、書き手ごとにどれだけ声が揺れているかを確かめてみよう。",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "h": "と、いうことで。",
        "p": [
          "この記事を読んだあなたが、ツールを入れる前にまずやるべきことは一つ。「機械に渡してよい層」と「人が握り続ける層」を紙の上で分けて書き出すことだ。表記の揺れやトーンの統一は、自動化したほうが速く正確だ。だが「この顧客を選ぶか」「この表現を却下するか」といった<em>ブランドの背骨に関わる判断</em>は、人の手元に残す。まずはこの二層の線を引いてみよう。",
    ...
    "sections": [
      ...
      },
      {
        ...
        "p": [
          ...
          "追われて変えるのと、選んで変えるのとでは、同じ社名変更でも意味がまるで違う。<em>主導権を持って選べるのは、余力のあるうちだけ</em>だ。名前を変えないという判断も、立派な選択である。好調な今こそ、次の十年を見据えて名前を問い直す価値がある。急がなくていい。ただ、この余裕のあるうちに一度立ち止まって考えることを、次の一手にしたい。"
        ]
      }
    ],
